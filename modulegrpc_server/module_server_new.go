...
// func post_use_create(ctx context.Context, in *pb.URL) (*pb.ShortURL, error) {
// 	createSql := `
...
func (s *UserManagmentServer) Create(ctx context.Context, in *pb.URL) (*pb.ShortURL, error) {
	if os.Getenv("DB_USAGE") == "true" { 
		...
		file, err := os.OpenFile("names.txt", os.O_CREATE|os.O_WRONLY|os.O_APPEND, os.ModePerm)
		if err != nil {
...
// func post_use_get(ctx context.Context, in *pb.URL) (*pb.URL, error) {
// 	log.Printf("Received: %v\n", in.GetShortname())
...
// func (server *UserManagmentServer) Runbd() error {
// 	lis, err := net.Listen("tcp", port)
// 	if err != nil {
// 		log.Fatalf("Fatal to listen: %v", err)
// 	}
...
// 	if err := user_mgmt_server.Runbd(); err != nil {
